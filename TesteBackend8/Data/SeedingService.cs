...
namespace TesteBackend8.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Turma t3 = new Turma(3, "Turma 3");

            Aluno a1 = new Aluno(1, "Teste1", 5.1, 6.2, 7.3, 8.4,t1,3.0);
            Aluno a2 = new Aluno(2, "Teste2", 5.2, 6.3, 7.4, 8.5,t2,4.1);
            Aluno a3 = new Aluno(3, "Teste3", 5.3, 6.4, 7.5, 8.6,t3,5.2);
            Aluno a4 = new Aluno(4, "Teste4", 5.4, 6.5, 7.6, 8.7, t1,6.3);
            Aluno a5 = new Aluno(5, "Teste5", 5.5, 6.6, 7.7, 8.8,t2,7.4);
            Aluno a6 = new Aluno(6, "Teste6", 5.6, 6.7, 7.8, 8.9,t3,8.5);
